...
$(document).on("change",".select-plugin",function () {
  $(this).parent().find("img").attr({src: $(this).find('option:selected').data("img")});
});
...
$(document).ready(function () {
  ...
  $(".select-plugin").select2({
    dropdownCssClass: "nice-select-2",
    minimumResultsForSearch: Infinity,
    dir: isRtl ? "rtl" : "ltr",
  });
  ...
  $(".main-nav-link .hint-link-cursor").on("click", function () {
    $(".subsections-menu").toggleClass("show");
    $(".main-subsection-ul").removeClass("show");
  });
  ...
  $(function () {
    $(".delivery-price-section .box-check").on("click", function () {
      $(this)
        .parents(".delivery-price-section")
        .find(".delivery-box")
        .toggleClass("show");
      if (
        $(this)
        ...
        $(this).parents(".delivery-price-section").find(".dl-input").val("");
      } else {
  ...
  $( ".dropdown-menu a, .dropdown-menu p, .dropdown-menu span" ).click(function( event ) {
    event.stopPropagation();
    // Do something
  });
});
